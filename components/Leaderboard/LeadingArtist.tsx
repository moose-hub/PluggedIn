...
// export default function LeadingArtist({image, name, numberOfSwipes}) {
  const LeadingArtist: FunctionComponent<Leader> = ({image, name, numberOfSwipes}) => {
    return (
      <div id="leader-container" className="flex items-center space-x-4 bg-[#e6e6e6] p-4 rounded-lg">
